...
?>
    <div class="row justify-content-between align-items-center" style="margin-bottom: 20px;">
        <?= form_label('Add Category:', 'title',['class'=>'col-lg-1 col-md-2 offset-1 offset-sm-0', 'style'=>'width:fit-content']) ?>
        <?= form_input('title', '', ['placeholder'=> 'New Category...', 'class'=>'col-lg-7 col-md-4'], 'text')?>
        <?= form_submit("addCategory", 'Save', ['class'=> 'col-lg-2 col-md-2 btn btn-primary']) ?>
    </div>
    <div class="row justify-content-between align-items-start">
        <div class="col-lg-1 col-md-2 offset-1 offset-sm-0">Existing:</div>
